...
import { getCurrentUser, isAuthenticated, onAuthStateChanged } from './services/authService';
...
function App() {
  ...
  const navigate = (page, parameters = {}) => {
    ...
    const protectedPages = ['dashboard', 'negozi', 'negozioForm', 'dipendenti', 'dipendenteForm', 'turni'];
  ...
  const renderPage = () => {
    switch(currentPage) {
      ...
      case 'negozioForm':
        return <NegozioForm onNavigate={navigate} negozioId={params.negozioId} />;
      case 'dipendenti':
        return <DipendentiList onNavigate={navigate} negozioId={params.negozioId} />;
      case 'dipendenteForm':
        ...
        />;
      case 'turni':
        return <TabellaTurni onNavigate={navigate} negozioId={params.negozioId} />;
      default:
        return <Login onNavigate={navigate} />;
    }
  };
