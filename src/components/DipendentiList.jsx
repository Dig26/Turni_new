...
import { getDipendentiByNegozioId, deleteDipendente } from '../services/api/dipendentiAPI';
import { getNegozioById } from '../services/api/negoziAPI';
import '../styles/DipendentiList.css';

function DipendentiList({ negozioId }) {
                  ...
                  <td>
                    <div className="action-buttons">
                      <button 
                        ...
                        onClick={() => navigate(`/negozi/${negozioId}/dipendenti/${dipendente.id}`)}
                        title="Modifica"
                      >
