...
const stripePromise = loadStripe('pk_test_51RokzO44cBL0j6ccULo1ETG8pqdRBPN6AIZoLWY5rNqR4XfvTnB9uwe9otWLLwq11u4MAgVTQX3SIXlEYAVuIlDF00iAWBHlLq');

// Componente per il form di pagamento (con clientSecret)
const CheckoutForm = ({ clientSecret, setupIntentId, customerId, priceId, numberOfShops, onBack, userEmail }) => {
    ...
    <div className="payment-section">
      ...
      <div className="order-summary">
        ...
        <div className="summary-item">
          ...
          <span>{(numberOfShops * 10 * (numberOfShops > 20 ? 0.75 : 1)).toFixed(2)}€/mese</span>
        </div>
...
const StripePaymentForm = () => {
  ...
  if (!paymentReady) {
    // Prima fase: selezione numero negozi
    return (
  ...
  // Seconda fase: pagamento con Elements
  return (
    <div className="stripe-payment-container">
      <div className="payment-header">
        <h2>Completa il pagamento</h2>
        <p className="payment-subtitle">
          Inserisci i dati della tua carta per attivare l'abbonamento
        </p>
      </div>
